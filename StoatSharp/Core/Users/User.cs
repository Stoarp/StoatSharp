...
public class User : CreatedEntity
{
    ...
    /// <summary>
    /// The relationship type of the user compared to the current user account.
    /// </summary>
    ...
    /// <summary>
    /// Is ther user blocked by the current user account.
    /// </summary>
    ...
    /// <summary>
    /// Known mutual DM channels for the current user account.
    /// </summary>
    [JsonIgnore]
    ...
    /// <summary>
    /// Known mutual servers that this user has for the current user account.
    /// </summary>
    /// <remarks>
    ...
    /// <summary>
    /// Known mutual group channels that this user has for the current user account.
    /// </summary>
    [JsonIgnore]
    ...
    /// <summary>
    /// Does the user have mutual servers, groups or DMs for the current user account.
    /// </summary>
    /// <remarks>
    /// This may not be fully accurate.
    /// </remarks>
...
/// <summary>
/// Relationship type compared to the current user account.
/// </summary>

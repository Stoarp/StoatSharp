...
public class ClientEvents
{
    ...
    /// <summary>
    /// The current user account has joined a <see cref="GroupChannel" />.
    /// </summary>
    ...
    /// <summary>
    /// The current user account has left a <see cref="GroupChannel" />.
    /// </summary>
    ...
    /// <summary>
    /// The current user account has joined a <see cref="Server" />.
    /// </summary>
    ...
    /// <summary>
    /// The current user account has left a <see cref="Server" />.
    /// </summary>
    ...
    /// <summary>
    /// The current user account has been updated.
    /// </summary>

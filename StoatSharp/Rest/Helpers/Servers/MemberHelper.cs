...
{
    /// <inheritdoc cref="AddRoleAsync(StoatRestClient, ServerMember, string)" />
    ...
    /// <inheritdoc cref="AddRoleAsync(StoatRestClient, ServerMember, string)" />
    public static Task AddRoleAsync(this StoatRestClient rest, ServerMember member, Role role)
    ...
    public static async Task AddRoleAsync(this StoatRestClient rest, ServerMember member, string roleId)
    {
    ...
    /// <inheritdoc cref="AddRolesAsync(StoatRestClient, ServerMember, string[])" />
    ...
    /// <inheritdoc cref="AddRolesAsync(StoatRestClient, ServerMember, string[])" />
    public static Task AddRolesAsync(this StoatRestClient rest, ServerMember member, Role[] roles)
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task AddRolesAsync(this StoatRestClient rest, ServerMember member, string[] roleIds)
    {
    ...
    /// <inheritdoc cref="RemoveRoleAsync(StoatRestClient, ServerMember, string)" />
    ...
    /// <inheritdoc cref="RemoveRoleAsync(StoatRestClient, ServerMember, string)" />
    public static Task RemoveRoleAsync(this StoatRestClient rest, ServerMember member, Role role)
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task RemoveRoleAsync(this StoatRestClient rest, ServerMember member, string roleId)
    {
    ...
    /// <inheritdoc cref="RemoveRolesAsync(StoatRestClient, ServerMember, string[])" />
    ...
    /// <inheritdoc cref="RemoveRolesAsync(StoatRestClient, ServerMember, string[])" />
    public static Task RemoveRolesAsync(this StoatRestClient rest, ServerMember member, Role[] roles)
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task RemoveRolesAsync(this StoatRestClient rest, ServerMember member, string[] roleIds)
    {
    ...
    /// <inheritdoc cref="GetMemberAsync(StoatRestClient, string, string)" />
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task<ServerMember?> GetMemberAsync(this StoatRestClient rest, string serverId, string userId)
    {
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task<IReadOnlyCollection<ServerMember>?> GetMembersAsync(this StoatRestClient rest, string serverId, bool onlineOnly = false)
    {
    ...
    /// <inheritdoc cref="KickMemberAsync(StoatRestClient, string, string)" />
    ...
    /// </summary>
    /// <remarks>
    /// Current user account needs <see cref="ServerPermission.KickMembers"/>
    /// </remarks>
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task KickMemberAsync(this StoatRestClient rest, string serverId, string userId)
    {
    ...
    /// </summary>
    /// <remarks>
    /// Current user account needs <see cref="ServerPermission.BanMembers"/>
    /// </remarks>
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    ...
    /// <inheritdoc cref="UnBanMemberAsync(StoatRestClient, string, string)" />
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task UnBanMemberAsync(this StoatRestClient rest, string serverId, string userId)
    {
    ...
    /// <inheritdoc cref="ModifyMemberAsync(StoatRestClient, string, string, Option{string}, Option{Attachment}, Option{DateTime?})" />
    ...
    /// <inheritdoc cref="ModifyMemberAsync(StoatRestClient, string, string, Option{string}, Option{Attachment}, Option{DateTime?})" />
    public static Task<ServerMember> ModifyMemberAsync(this StoatRestClient rest, Server server, string memberId, Option<string?>? nickname = null, Option<Attachment?>? avatar = null, Option<DateTime?>? timeout = null)
    {
    ...
    /// <exception cref="StoatArgumentException"></exception>
    /// <exception cref="StoatRestException"></exception>
    public static async Task<ServerMember> ModifyMemberAsync(this StoatRestClient rest, string serverId, string memberId, Option<string?>? nickname = null, Option<Attachment?>? avatar = null, Option<DateTime?>? timeout = null)
    {
